...
<nav class="navbar navbar-expand-md bg-light navbar-light shadow">
    <div class="container">
        <a href="{{route('view.home')}}" class="navbar-brand">Blog With Category</a>
        <ul class="navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    ...
                    <li><a href="{{route('view.blog-category',['id'=>$category->id])}}" class="dropdown-item">{{$category->name}}</a></li>
                    @endforeach
